...
namespace Egoteric.Content.GUI
{
    ...
    {
        public static bool Visible => PlaceStructure.UIVisible;
        ...
        {
            PlaceStructure.UIVisible = false;
        }
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            {
                Main.hoverItemName = "Reload Structures";
                Main.LocalPlayer.mouseInterface = true;
            }

            if (closeButton.IsMouseHovering)
            {
                Main.hoverItemName = "Close UI";
                Main.LocalPlayer.mouseInterface = true;
            }
    ...
    class StructureEntry : UIElement
    {
        ...
        bool active => GeneratorMenu.selected == this;
        ...
        public override void Draw(SpriteBatch spriteBatch)
        {
            ...
            GeneratorMenu.DrawBox(spriteBatch, mainBox, IsMouseHovering || active ? new Color(49, 84, 141) : new Color(49, 84, 141) * 0.6f);
        ...
        public override void Click(UIMouseEvent evt)
        {
            ...
            {
                GeneratorMenu.multiMode = true;

                var count = StructureGenerator.StructureDataCache[Path].Get<List<TagCompound>>("Structures").Count;
    ...
    class MultiSelectionEntry : UIElement
    {
        ...
        bool active => GeneratorMenu.multiIndex == value;
        ...
        public override void Draw(SpriteBatch spriteBatch)
        {
            ...
            GeneratorMenu.DrawBox(spriteBatch, GetDimensions().ToRectangle(), IsMouseHovering || active ? new Color(49, 84, 141) : new Color(49, 84, 141) * 0.6f);
        ...
        public override void Click(UIMouseEvent evt)
        {
            GeneratorMenu.multiIndex = value;
        }
    }
}
