...
namespace Egoteric.Common.World.ChestHelper.GUI
{
    class ChestRuleElement : UIElement
    {
        ...
        public override void Draw(SpriteBatch spriteBatch)
        {
            ...
            GeneratorMenu.DrawBox(spriteBatch, target, color);
        ...
        {
            if (!(Parent.Parent.Parent is ChestCustomizer)) return;

            ChestCustomizer parent = Parent.Parent.Parent as ChestCustomizer;
